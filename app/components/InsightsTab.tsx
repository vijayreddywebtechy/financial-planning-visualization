  ...
  return (
    <>
      ...
      <div className="bg-gradient-to-br from-purple-900/20 to-slate-900/30 backdrop-blur-sm rounded-2xl p-6 border border-purple-500/30 mb-8">
        ...
        <p className="text-slate-400 text-sm mb-4">AI-powered insights with actionable next steps for client advisory</p>
        
        <div className="grid grid-cols-4 gap-4">
          <button className="flex items-center gap-3 p-4 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 rounded-xl shadow-lg shadow-purple-500/20 transition-all">
            <Repeat className="w-5 h-5 text-white" />
            <div className="text-left">
              <div className="text-white font-medium text-sm">Send Rebalancing</div>
              <div className="text-purple-100 text-xs">Proposal to client</div>
            </div>
          </button>
          ...
          <button className="flex items-center gap-3 p-4 bg-slate-800/50 hover:bg-slate-700/50 rounded-xl border border-slate-700/50 transition-all">
            ...
            <div className="text-left">
              <div className="text-white font-medium text-sm">Schedule Review</div>
              <div className="text-slate-500 text-xs">Book meeting</div>
            </div>
          </button>
          ...
          <button className="flex items-center gap-3 p-4 bg-slate-800/50 hover:bg-slate-700/50 rounded-xl border border-slate-700/50 transition-all">
            ...
            <div className="text-left">
              <div className="text-white font-medium text-sm">Export Analysis</div>
              <div className="text-slate-500 text-xs">Full report</div>
            </div>
          </button>
          ...
          <button className="flex items-center gap-3 p-4 bg-slate-800/50 hover:bg-slate-700/50 rounded-xl border border-slate-700/50 transition-all">
            ...
            <div className="text-left">
              ...
              <div className="text-slate-500 text-xs">Action item</div>
            </div>
          </button>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-br from-teal-900/30 via-emerald-900/20 to-slate-900/30 backdrop-blur-sm rounded-2xl p-8 border border-emerald-500/30 mb-8">
        <div className="flex items-center gap-3 mb-4">
          <div className="w-12 h-12 bg-emerald-500/20 rounded-xl flex items-center justify-center">
            <Shield className="w-6 h-6 text-emerald-400" />
          </div>
          <h3 className="text-emerald-400 font-semibold text-lg">Overall Portfolio Health</h3>
        </div>
        <div className="text-emerald-400 text-6xl font-bold mb-4">73.8<span className="text-3xl">/100</span></div>
      ...
      <div className="grid grid-cols-2 gap-6 mb-8">
        ...
        <div className="bg-gradient-to-br from-slate-800/40 to-slate-900/40 backdrop-blur-sm rounded-2xl p-6 border border-slate-700/50">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-slate-400 text-sm">Multi-dimensional analysis</p>
            </div>
          </div>
        ...
        <div className="bg-gradient-to-br from-slate-800/40 to-slate-900/40 backdrop-blur-sm rounded-2xl p-6 border border-slate-700/50">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h3 className="text-white font-semibold text-lg">Asset Coverage</h3>
              <p className="text-slate-400 text-sm">Risk protection over time</p>
            </div>
          </div>
          <ResponsiveContainer width="100%" height={300}>
      ...
      <div className="bg-gradient-to-br from-slate-800/40 to-slate-900/40 backdrop-blur-sm rounded-2xl p-6 border border-slate-700/50 mb-8">
        <div className="flex items-center gap-3 mb-6">
          <div className="w-10 h-10 bg-orange-500/20 rounded-xl flex items-center justify-center">
            <Target className="w-5 h-5 text-orange-400" />
          </div>
          <div>
            <h3 className="text-white font-semibold text-lg">Portfolio Hierarchy</h3>
            <p className="text-slate-400 text-sm">Company → Accounts → Holdings breakdown</p>
          </div>
        </div>
        <ResponsiveContainer width="100%" height={300}>
          <Treemap
        ...
        <div className="bg-gradient-to-br from-slate-800/40 to-slate-900/40 backdrop-blur-sm rounded-2xl p-6 border border-slate-700/50">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-white font-semibold text-lg">Diversification</h3>
            </div>
        ...
        <div className="bg-gradient-to-br from-slate-800/40 to-slate-900/40 backdrop-blur-sm rounded-2xl p-6 border border-slate-700/50">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-white font-semibold text-lg">Financial Health</h3>
            </div>
            <div className="text-right">
              <div className="text-purple-400 text-3xl font-bold">98</div>
              <div className="text-slate-400 text-xs">out of 100</div>
            </div>
          </div>
          <p className="text-slate-400 text-sm mb-4">
        ...
        <div className="bg-gradient-to-br from-slate-800/40 to-slate-900/40 backdrop-blur-sm rounded-2xl p-6 border border-slate-700/50">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-white font-semibold text-lg">Portfolio Balance</h3>
            </div>
            <div className="text-right">
              <div className="text-pink-400 text-3xl font-bold">60</div>
              <div className="text-slate-400 text-xs">out of 100</div>
            </div>
          </div>
          <p className="text-slate-400 text-sm mb-4">
        ...
        <div className="bg-gradient-to-br from-slate-800/40 to-slate-900/40 backdrop-blur-sm rounded-2xl p-6 border border-slate-700/50">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-white font-semibold text-lg">Institution Spread</h3>
            </div>
            <div className="text-right">
              <div className="text-orange-400 text-3xl font-bold">90</div>
              <div className="text-slate-400 text-xs">out of 100</div>
            </div>
          </div>
          <p className="text-slate-400 text-sm mb-4">
      ...
      <div className="bg-gradient-to-br from-slate-800/40 to-slate-900/40 backdrop-blur-sm rounded-2xl p-6 border border-slate-700/50">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h3 className="text-white font-semibold text-lg">Institution Performance</h3>
            <p className="text-slate-400 text-sm">Net position comparison</p>
          </div>
        </div>
