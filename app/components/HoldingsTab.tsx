  ...
  return (
    <>
      ...
      <div className="bg-gradient-to-br from-slate-800/30 to-slate-900/30 backdrop-blur-sm rounded-2xl p-6 border border-slate-700/50 mb-8">
        ...
        <p className="text-slate-400 text-sm mb-4">Client relationship and portfolio management tools</p>
      ...
      <div className="flex gap-4 mb-8">
        ...
        <button className="px-6 py-3 bg-blue-600/20 text-blue-400 rounded-xl border border-blue-500/50 font-medium">
          All
        </button>
        <button className="px-6 py-3 text-slate-400 hover:text-slate-300 rounded-xl font-medium">
          Assets
        </button>
        <button className="px-6 py-3 text-slate-400 hover:text-slate-300 rounded-xl font-medium">
          Liabilities
      ...
      <div className="bg-gradient-to-br from-slate-800/40 to-slate-900/40 backdrop-blur-sm rounded-2xl p-6 border border-slate-700/50 mb-8">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h3 className="text-white font-semibold text-lg">Holdings Distribution</h3>
            <p className="text-slate-400 text-sm">Number of holdings per institution</p>
          </div>
        </div>
      ...
      <div className="space-y-4">
        {accounts.map((account) => (
          <div
            key={account.id}
            className="bg-gradient-to-br from-slate-800/40 to-slate-900/40 backdrop-blur-sm rounded-2xl border border-slate-700/50 overflow-hidden"
          >
            <div className="p-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4 flex-1">
                  ...
                  <div className="flex-1">
                    ...
                    <h4 className="text-white font-semibold text-lg mb-1">{account.accountName}</h4>
            ...
            {expandedAccount === account.id && account.holdings > 0 && individualHoldings[account.id] && (
              <div className="border-t border-slate-700/50 p-6 bg-slate-900/50">
                <div className="flex items-center gap-2 mb-6">
                  ...
                  <h4 className="text-white font-semibold text-lg">Individual Holdings</h4>
                </div>
                ...
                <div className="grid grid-cols-3 gap-4">
                  {individualHoldings[account.id].map((holding, idx) => (
                    <div 
                      key={idx}
                      className="bg-gradient-to-br from-slate-800/60 to-slate-900/60 backdrop-blur-sm rounded-xl p-5 border border-slate-700/50 hover:border-slate-600/50 transition-all"
                    >
